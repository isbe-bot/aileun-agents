...
`aileun-agents` stores local operational metadata in SQLite and canonical runtime files. Runtime data may include paths, definitions, manifest metadata, or hashes depending on the manager.
